...
use DB;
use App\Models\{Siswa , Kelas , Spp , Pembayaran , view_bayar};
use Carbon\Carbon;
class PembayaranController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.pembayaran.index' , compact('data' , 'siswa'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($pembayaranSimpan) {
            return redirect()->route('admin.index.pembayaran')->with('success', 'Data berhasil disimpan');
        } else {
